        ...
        <table className="w-full overflow-x-auto divide-y divide-gray-200">
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {data.map(function (row, rowIndex) {
             ...
             {  actions &&   <td className="px-6 py-4 text-right text-sm font-medium">
                    <Menu as="div" className="relative inline-block text-left">
                      <Menu.Button className="inline-flex justify-center w-full rounded-md border
                       border-gray-300 shadow-sm px-4 py-2 bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none">
                        <svg
                      ...
                      >
                        <Menu.Items className="origin-top-right absolute right-0 mt-2 w-56 max-h-40 overflow-y-auto 
                        rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 focus:outline-none">
                          <div className="py-4">
                            ...
                            {  actions && actions.map(function (action, actionIndex) {
                              return (
