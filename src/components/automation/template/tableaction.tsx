...
const groups=["dfg4","fer"]
function AutomationTemplateTableAction({ item }: TableHeaderActionProp<AutomatiomTemplate>) {
...
export default AutomationTemplateTableAction;
