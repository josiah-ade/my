  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose}>
      <div className="max-w-lg text-sm space-y-5 mx-auto">
        ...
        <div>
          <label className="block font-medium text-gray-900 capitalize">Exclude Contacts From {formData.type} </label>
          ...
          <p className="text-gray-600 text-sm mt-1">
            We will not send to contacts in the list(s) you selected if they are found in any of the selected list(s)
            here
          </p>
        </div>

        <div>
          <label className="block font-medium text-gray-900">Send to Contacts who joined on a particular date</label>
