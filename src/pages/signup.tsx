...
export default function LoginPage() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[100vh] w-full px-6 md:px-0">
      ...
      <form onSubmit={handleClick} className="w-full max-w-[32.50rem] mx-auto py-10 rounded-md bg-white px-6 md:px-0 ">
        <div className="w-full  mx-auto align-center">
          ...
          <div className={`mt-5 relative flex flex-row gap-10`}>
            {/* name input */}
