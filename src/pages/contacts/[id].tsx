      ...
      const tabs = [
        {
          ...
          content: (
           ...
           <div >
            ...
            <p className="text-[1rem] text-wrap w-full max-w-[300px] ">384 contacts you have selected would be added to a new broadcast list </p>
           </div>
        ...
        },
        {
          ...
          content: (
            ...
            <div>
             ...
             <p className="text-[1rem] text-wrap w-full max-w-[300px] ">384 contacts you have selected would be added to an existing broadcast list  </p>
            </div>
            <div  className={`mt-5 relative `}>
               <label className="font-bold">Select List</label><br></br>
               <div className="mt-2">
               <input
                 name="name"
                 autoComplete="off"
