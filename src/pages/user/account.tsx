      ...
      content: (
        <div className="max-w-md mx-auto bg-white p-6 rounded-lg">
          ...
          <p className="mb-4 text-sm text-black leading-6">
            To link with a pairing code, open WhatsApp on the phone where 8038548936 is after you have
            requested, you will be prompted to input a pairing code, copy the code shown here and paste on your device. After few seconds, it'll show 'Connected' here, you can close this window after that.
          </p>
    ...
    },
    {
      ...
      content: (
        <div className="max-w-md mx-auto bg-white p-6 rounded-lg">
          ...
          <p className="mb-4 text-sm text-black leading-6">
            To link with a QR code, open WhatsApp on your phone, go to the settings, and tap on 'Link a Device'. Scan the QR code shown on this screen with your phone.
          </p>
          <div className="flex items-center justify-center mb-4">
            ...
            <section className="lg:flex lg:space-x-4 mt-8">
              <section className="px-4 py-8 lg:w-[50%] lg:flex justify-between bg-green-50 border border-green-50 rounded-lg">
                <div className="">
                    ...
                    <p className="text-sm text-gray-600 mt-1">Please update/verify your information before <br /> <strong>13th July 2023 </strong> to unlock level benefits</p>
                  </div>
