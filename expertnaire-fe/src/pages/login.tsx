      ...
      <form className="w-full width-[100%] max-w-[600px] mx-auto py-10 rounded-md bg-white  border-blue-400  border-solid border-4 px-6 md:px-0 ">
          <div className="w-full max-w-[500px] mx-auto align-center">
            ...
            <div className="mt-6 items-center flex justify-center flex-col">
              ...
              <p className="text-1xl">Continue with Google</p><button className="pl-2"><FcGoogle size={18} /></button>
              <button><GrFacebookOption  size={25} className="pl-3 text-blue-800"/></button>
              </div>
              {/* <p className="text-blue-400  items-end flex justify-end flex-row">Forgot Password?</p>
              <button className="text-2xl mt-8 bg-slate-500 hover:bg-slate-400 py-3 px-7 rounded-2xl text-white w-full max-w-[700px] items-center">
